...
namespace mdf {
  ...
  void CanConfigAdapter::CreateCanDataFrameChannel ( IChannelGroup& group )
  const {
    const bool mandatory_only = MandatoryMembersOnly ();
    ...
    if ( IChannel* length = CreateBitsChannel ( *cn_data_frame,
                            "CAN_DataFrame.DataLength", 14, 0, 8 );
         length != nullptr ) {
      length->Unit ( "B" );
    }
    ...
    if ( IChannel* duration = CreateBitsChannel ( *cn_data_frame,
                              "CAN_DataFrame.FrameDuration", 16, 0, 32 );
         duration != nullptr ) {
      duration->Unit ( "ns" );
    }
  ...
  void CanConfigAdapter::CreateCanRemoteFrameChannel ( IChannelGroup& group )
  const {
    const bool mandatory_only = MandatoryMembersOnly ();
    ...
    if ( IChannel* length = CreateBitsChannel ( *cn_remote_frame,
                            "CAN_RemoteFrame.DataLength", 14, 0, 8 );
         length != nullptr ) {
      length->Unit ( "B" );
    }
    ...
    if ( IChannel* duration = CreateBitsChannel ( *cn_remote_frame,
                              "CAN_RemoteFrame.FrameDuration", 16, 0, 32 );
         duration != nullptr ) {
      duration->Unit ( "ns" );
    }
  ...
  void CanConfigAdapter::CreateCanErrorFrameChannel ( IChannelGroup& group )
  const {
    ...
    if ( IChannel* length = CreateBitsChannel ( *cn_error_frame,
                            "CAN_ErrorFrame.DataLength", 14, 0, 8 );
         length != nullptr ) {
      length->Unit ( "B" );
    }
    ...
    if ( IChannel* duration = CreateBitsChannel ( *cn_error_frame,
                              "CAN_ErrorFrame.FrameDuration", 16, 0, 32 );
         duration != nullptr ) {
      duration->Unit ( "ns" );
    }
