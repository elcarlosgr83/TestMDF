...
namespace mdf {
  ...
  HoDataTermination StringToHoDataTermination ( const std::string& termination ) {
    return StringToEnumerate<HoDataTermination, 4> ( termination,
           kDataTerminationList,
  ...
  std::string_view HoComputationMethodCategoryToString (
    ...
    const auto index = static_cast<size_t> ( category );
    return index < kComputationMethodCategoryList.size () ?
           kComputationMethodCategoryList [ index ] : "";
  }

  HoComputationMethodCategory StringToHoComputationMethodCategory (
    const std::string& category ) {
    return StringToEnumerate<HoComputationMethodCategory, 6> ( category,
           kComputationMethodCategoryList,
  ...
  std::string_view HoUnitGroupCategoryToString (
    ...
    const auto index = static_cast<size_t> ( category );
    return index < kUnitGroupCategoryList.size () ? kUnitGroupCategoryList [
             index ] : "";
  }

  HoUnitGroupCategory StringToHoUnitGroupCategory ( const std::string&
      category ) {
    return StringToEnumerate<HoUnitGroupCategory, 2> ( category,
           kUnitGroupCategoryList,
