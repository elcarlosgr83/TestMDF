...
namespace mdf {
  ...
  void MostConfigAdapter::CreateEthernetPacketChannel ( IChannelGroup&
      channel_group ) const {
  ...
  void MostConfigAdapter::CreatePacketChannel ( IChannelGroup& channel_group )
  const {
    const bool mandatory_members_only = MandatoryMembersOnly ();
  ...
  void MostConfigAdapter::CreateMessageChannel ( IChannelGroup& channel_group )
  const {
    const bool mandatory_members_only = MandatoryMembersOnly ();
  ...
  void MostConfigAdapter::CreateSignalStateChannel ( IChannelGroup&
      channel_group ) const {
  ...
  void MostConfigAdapter::CreateMaxPosInfoChannel ( IChannelGroup& channel_group )
  const {
  ...
  void MostConfigAdapter::CreateBoundDescChannel ( IChannelGroup& channel_group )
  const {
  ...
  void MostConfigAdapter::CreateAllocTableChannel ( IChannelGroup& channel_group )
  const {
  ...
  void MostConfigAdapter::CreateSysLockStateChannel ( IChannelGroup&
      channel_group ) const {
  ...
  void MostConfigAdapter::CreateShutdownFlagChannel ( IChannelGroup&
      channel_group ) const {
  ...
  void MostConfigAdapter::CreateMandatoryMembers ( IChannel& parent_frame )
  const {
    CreateBusChannel ( parent_frame );
    CreateSpeedChannel ( parent_frame, 9 );
    CreateTransferTypeChannel ( parent_frame, 9 );
