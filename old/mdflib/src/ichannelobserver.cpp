...
namespace {
  std::string FormatArray ( const mdf::IChannelArray& array,
                            uint16_t dimension ) {
...
namespace mdf {
  ...
  IChannelObserver::IChannelObserver ( const IDataGroup& data_group,
  ...
  template <>
  bool IChannelObserver::GetChannelValue ( uint64_t sample, std::string& value,
