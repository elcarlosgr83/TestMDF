...
namespace mdf {
  ...
  public:
    ...
    [ [ nodiscard ] ] bool IsAttribute ( const std::string &key,
       ...
       */
      template <typename T>
    [ [ nodiscard ] ] T Attribute ( const std::string &key, const T &def = {} )
      const;
    ...
    [ [ nodiscard ] ] T Value () const;
       ...
       */
      template <typename T>
    [ [ nodiscard ] ] T Property ( const std::string &key, const T &def = {} )
      const {
  ...
  template <>
  inline bool IXmlNode::Attribute ( const std::string& key,
