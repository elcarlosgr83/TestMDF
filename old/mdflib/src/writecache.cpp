...
namespace mdf::detail {
  ...
  void WriteCache::WorkThread () {
    ...
    for ( auto& [ data_group, sample_queue ] : cache_ ) {
              ...
              void WriteCache::SaveSample ( const IChannelGroup& channel_group,
              uint64_t time ) {
  ...
  void WriteCache::SaveCanMessage ( const IChannelGroup& channel_group,
                                    uint64_t time,
  ...
  void WriteCache::SaveLinMessage ( const IChannelGroup& channel_group,
                                    uint64_t time,
  ...
  void WriteCache::SaveEthMessage ( const IChannelGroup& channel_group,
                                    uint64_t time,
