...
namespace mdf::detail {
  ...
  void DataListBlock::ReadBlockList ( std::streambuf& buffer,
                                      size_t data_index ) {
  ...
  void DataListBlock::WriteBlockList ( std::streambuf& buffer,
                                       size_t first_index ) {
  ...
  void DataListBlock::GetDataBlockList ( std::vector<DataBlock*>& block_list )
  const {
    for ( const auto& block : block_list_ ) {
      if ( !block ) {
        continue;
